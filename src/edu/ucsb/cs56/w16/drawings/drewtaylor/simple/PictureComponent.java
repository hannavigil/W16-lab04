package edu.ucsb.cs56.w16.drawings.drewtaylor.simple;
...
/**
   ...
   @author Drew Taylor (fixed the snowmans's head)
...
{  
	...
	// @@@ 20, 20 are suggested coordinates, but you may change them
        ...
        g2.drawString("Drew Taylor - UCSB on an oddly snowy day", 20,20);
