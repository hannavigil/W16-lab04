package edu.ucsb.cs56.w16.drawings.ryantse.simple;
...
/**
   ...
   @author Ryan Tse (fixed the snowmans's head and updated description)
...
{  
    ...
    {  
        ...
        g2.drawString("Complete Snowman by Ryan Tse", 20,20);
