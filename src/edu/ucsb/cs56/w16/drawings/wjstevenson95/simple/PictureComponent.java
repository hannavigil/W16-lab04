package edu.ucsb.cs56.w16.drawings.wjstevenson95.simple;
...
/**
   ...
   @author William Stevenson (fixed the snowmans's head)
...
{  
	...
	g2.drawString("Snowman, William Stevenson", 20,20);
