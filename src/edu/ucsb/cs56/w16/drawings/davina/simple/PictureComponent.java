package edu.ucsb.cs56.w16.drawings.davina.simple;
...
/**
   ...
   @author Davina Zamanzadeh (fixed the snowmans's head)
...
{  
    ...
    {  
       ...
       g2.draw(snowManTopCircle);
        ...
        g2.drawString("Davina Zamanzadeh's drawing of a complete snowman with a house", 20,20);
